...
\twocolumn[
  ...
  \begin{icmlauthorlist}
    \icmlauthor{Benjamin Attabra}{knust}
  \end{icmlauthorlist}

  \icmlaffiliation{knust}{Kwame Nkrumah University of Science and Technology, Kumasi, Ghana}
  \icmlcorrespondingauthor{Benjamin Attabra}{beattabra@st.knust.edu.gh}
...
\begin{enumerate}
  ...
  \item \textbf{Synthetic-to-real gap:} We compare results to a prior
        synthetic benchmark~\cite{attabra2026seqcredit}, finding that
...
A companion study~\cite{attabra2026seqcredit} evaluated the same
