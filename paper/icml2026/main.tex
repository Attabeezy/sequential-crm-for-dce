...
0.733 for strict default prediction without any credit bureau features.
...
\begin{enumerate}
  ...
  \item \textbf{Real-data baseline:} AUC-ROC of 0.733 for strict default
...
\multirow{4}{*}{$y_{\text{default}}$}
  & XGBoost             & \textbf{0.7330} & \textbf{0.1113} & 0.1583 & \textbf{0.1744} & \textbf{0.3175} \\
  & LightGBM            & 0.7303 & 0.1103 & 0.1573 & 0.1752 & 0.3196 \\
  & Random Forest       & 0.7243 & 0.1015 & \textbf{0.1613} & \textbf{0.1612} & \textbf{0.3155} \\
  & Logistic Regression & 0.7082 & 0.0974 & 0.1398 & 0.2193 & 0.3976 \\
\midrule
\multirow{4}{*}{$y_{\text{bad}}$}
  & LightGBM            & \textbf{0.7312} & \textbf{0.7804} & 0.6996 & \textbf{0.2089} & \textbf{0.0666} \\
  & XGBoost             & 0.7295 & 0.7794 & \textbf{0.7408} & 0.3591 & 0.3632 \\
  & Random Forest       & 0.7204 & 0.7694 & 0.6913 & 0.2143 & 0.0739 \\
  & Logistic Regression & 0.6917 & 0.7475 & 0.6667 & 0.2225 & 0.0736 \\
\bottomrule
\end{tabular}
\end{small}
\end{center}
...
For $y_{\text{default}}$, XGBoost achieves the best AUC-ROC (0.733),
with all gradient boosting models clustered in 0.724--0.733 and LR
trailing at 0.708.
For $y_{\text{bad}}$, the task is better-conditioned (58.2\% positive
rate): LightGBM leads at AUC-ROC 0.731 with excellent calibration
(ECE 0.007), while XGBoost achieves the best F1 (0.741) but with
poor calibration (ECE 0.363).
...
On real data the same models achieve 0.733 and 0.730 — a gap of
...
transaction history predict strict default with AUC-ROC of 0.733 on
